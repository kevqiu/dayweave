...
CREATE UNIQUE INDEX "oauthClientResource_clientId_resourceId_idx" ON "oauthClientResource" ("clientId", "resourceId");
...
CREATE TRIGGER oauth_consent_revoke_tokens
AFTER DELETE ON "oauthConsent"
BEGIN
  DELETE FROM "oauthAccessToken" WHERE "clientId" = OLD."clientId" AND "userId" = OLD."userId";
  DELETE FROM "oauthRefreshToken" WHERE "clientId" = OLD."clientId" AND "userId" = OLD."userId";
END;
